...
const SpecularButton = ({
  ...
  useEffect(() => {
    ...
    const update = (now: number) => {
      ...
      program.uniforms.uRadius.value = Math.min((p.radius as number) || 18, Math.min(sizeRef.w, sizeRef.h) / 2) * dpr;
      program.uniforms.uLineColor.value = [lineC.r, lineC.g, lineC.b];
      program.uniforms.uBaseColor.value = [baseC.r, baseC.g, baseC.b];
      program.uniforms.uIntensity.value = (p.intensity as number) * bright;
      ...
      program.uniforms.uThickness.value = (p.thickness as number) * dpr;
